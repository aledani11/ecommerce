                ...
                <div class="col-12 col-md-8 col-lg-9">
                    ...
                    <nav aria-label="navigation">   
                        <ul class="pagination mt-50 mb-70">
                            <li class="page-item"><a class="page-link" href="{{route('shop',['page'=>'1'])}}"><i class="fa fa-angle-left"></i></a></li>
                            @for($i=0; $i<$pages;$i++)
                            <li class="page-item"><a class="page-link" href="{{route('shop')}}?page={{$i+1}}">{{$i+1}}</a></li>
                            @endfor
                            <li class="page-item"><a class="page-link" href="{{route('shop')}}?page={{$pages}}"><i class="fa fa-angle-right"></i></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
